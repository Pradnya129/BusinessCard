...
const API_BASE = "https://appo.coinagesoft.com/api/superAdmin/sub_plans";
...
const Plans = () => {
  ...
  const fetchAdmins = async () => {
    try {
      const res = await axios.get(`https://appo.coinagesoft.com/api/superadmin/manageAdmins/`, { headers: getAuthHeaders() });
      setAdmins(res.data || []);
    } catch (err) {
